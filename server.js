...
app.post('/submit', (req, res) => {
    ...
    const query = 'INSERT INTO packing_list (destination, startDate, endDate, packingList) VALUES (?, ?, ?, ?)';
...
app.get('/data', (req, res) => {
    const query = 'SELECT * FROM packing_list';
...
app.delete('/delete/:id', (req, res) => {
    const { id } = req.params;
    const query = 'DELETE FROM packing_list WHERE id = ?';
